...
export function ZConsole() {
  return (
    <>
      <Stack bc="$color12">
        <YStack themeInverse="true" bc="$color1" maw={1200} m="$3">
          <Eyebrow>Product Design</Eyebrow>
          <Title>zConsole</Title>
          <Paragraph fontWeight="bold" mt="$5">
            Some of the names used in this case study may not match the current product suite, as
            they were changed during and after this process.
          </Paragraph>
          <Paragraph mt="$5">
            zConsole is an administrative dashboard used by mobile app developers and cybersecurity
            teams of large enterprises. During my time at Zimperium, I managed feature designs for 2
            versions of this console, called V4 and V5. Below is a brief comparison between the two.
          </Paragraph>
        </YStack>
      </Stack>
      ...
      <Stack bc="$color12">
        <YStack themeInverse="true" bc="$color1" maw={1200} m="auto">
          ...
          >
            ...
            <Paragraph fontWeight="bold" mt="$5">
              Some of the names used in this case study may not match the current product suite, as
              some of the names were changed during and after this process.
            </Paragraph>
            <Paragraph mt="$5">
          ...
          <XStack gap="$6">
            <YStack bc="$color6" p="$3" w="100%" f={1} ai="center">
              ...
              {/*<XStack gap="$3">*/}
              {/*  <YStack boc="$green9" bw="$1" p="$3">*/}
              {/*    <Paragraph fontWeight="bold">Pros</Paragraph>*/}
              {/*    <Paragraph>More Features</Paragraph>*/}
              {/*    <Paragraph>Widely used</Paragraph>*/}
              {/*    <Paragraph>Proven to work</Paragraph>*/}
              {/*  </YStack>*/}
              {/*  <YStack boc="$red9" bw="$1" p="$3">*/}
              {/*    <Paragraph fontWeight="bold">Cons</Paragraph>*/}
              {/*    <Paragraph>More Features</Paragraph>*/}
              {/*    <Paragraph>Widely used</Paragraph>*/}
              {/*    <Paragraph>Proven to work</Paragraph>*/}
              {/*  </YStack>*/}
          ...
          <YStack
            ...
            gap="$3"
          >
            {/*<Paragraph mt="$5">Each console manages 4 products:</Paragraph>*/}
            {/*<ListItem>*/}
            {/*  <Paragraph fontWeight="bold">zScan: </Paragraph> scans a mobile app for*/}
            {/*  vulnerabilities*/}
            {/*</ListItem>*/}
            {/*<ListItem>*/}
            {/*  <Paragraph fontWeight="bold">zDefend: </Paragraph> an SDK package provided to mobile*/}
            {/*  developers to prevent malware*/}
            {/*</ListItem>*/}
            {/*<ListItem>*/}
            {/*  <Paragraph fontWeight="bold">zIPS Console: </Paragraph> the command center for*/}
            {/*  managing company devices*/}
            {/*</ListItem>*/}
            {/*<ListItem>*/}
            {/*  <Paragraph fontWeight="bold">z3A: </Paragraph> mitigates risk associated with*/}
            {/*  third-party apps*/}
            {/*</ListItem>*/}
            ...
            <YStack gap="$3">
              ...
              {/*<Paragraph>*/}
              {/*  As customers demanded more features and project managers directed the team’s*/}
              {/*  approach, here are a few of the major tasks I was assigned when designing new*/}
          ...
          <YStack gap="$6">
            ...
            <XStack gap="$6">
              ...
              <YStack p="$3" w="100%" f={1} gap="$3" ai="center">
                <YStack gap="$3"></YStack>
              </YStack>
            </XStack>
          </YStack>
