        ...
        <YStack themeInverse="true" bc="$color1" maw={1200} m="auto">
          ...
          >
            ...
            <Paragraph>
              ...
              thought about how to best solve their issues.
            </Paragraph>

            <Paragraph>
              Scoutify plans to become a talent scouting portal for baseball players. Currently,
              scouting for this sport is very basic. There are not many tools, as not many scouts
              are able to find the resources they need. It’s technically still a very new industry.
              There isn’t a platform for players to showcase their skills to the outside world. Most
              of this data is heavily related to match performances, but scouting can be a very
              complicated task.
            </Paragraph>
            ...
            <Paragraph>
              Scoutify plans to promote itself through all the various baseball related websites,
              such as pro-shops, academies, leagues, national governing bodies, and schools.
            </Paragraph>

            <Paragraph>
              In the future, Scoutify plans to implement AI and machine learning to generate scores
              to help talent scouting agents find the best athletes around the world.
            </Paragraph>
            ...
            <Paragraph>
              ...
              steps I’d need to take to move forward. Below are some user flows I created, along
              with additional questions that arose as I continued this task.
            </Paragraph>

            <Paragraph>
              This process proved useful, as I discovered there would be a fourth and fifth user
              type that was not previously discussed during our initial meeting. One user type would
              be the Parent account, as we would not allow children under the age of 13 to manage
              their own account. The other would be a Super Admin account, that had full user
              management abilities for any and all other users.
            </Paragraph>
          ...
          >
            ...
            <Paragraph>
              This diagram also shows what will happen when a Youth Athlete turns old enough to
              become an Adult Athlete, and how the account should be upgraded so that the user can
              manage their own account. The Parent account would no longer have access to manage
          ...
          >
            <Paragraph>
              ...
              Organization. It further shows what should happen if the user too young to create an
              Adult Athlete account, and how a Parent account can be created instead.
            </Paragraph>
          </YStack>
          <Stack w="100%" ai="center">
            <Stack
          ...
          >
            ...
            <Paragraph>
              ...
              create a few mocks using low fidelity wireframes. Below is the initial concept I came
              up with. This is just the first draft, and I planned to iterate on this design as I
          ...
          >
            ...
            <Paragraph>
              ...
              my design. In order to maintain consistency within the site, I started by creating a
              few master components that could be reused over and over. By taking these initial
              steps, I could ensure that any changes moving forward could be made with minimal
              effort. For example if the client later decides to add a logo or change the tagline,
              to the navigation bar, making that addition would only need to be done to the master
          ...
          >
            ...
            <Paragraph>
              ...
              the top half of the screen, while modules for any other categorized content displayed
              below. Next are some more refined screens of an athlete profile.
            </Paragraph>
          </YStack>
          <Stack w="100%" ai="center">
            <Stack
          ...
          >
            <Paragraph>
              ...
              as any of the user types. This functional prototype shows how a user first lands on
              this website and creates a new account. The bottom section allows the demo user to
              quickly jump to different parts of the user flow, such as logging in as a Super Admin
              or after setting up an account. This way, the demo user does not need to go through
              the whole account creation process just to see how the screen looks as a new user.
            </Paragraph>
          </YStack>
